...
import { whiteoutFacilities, whiteoutFortresses, whiteoutStrongholds, whiteoutResources, whiteoutEvents, whiteoutBuildings, whiteoutResearch, whiteoutTroops, whiteoutBearTrap, whiteoutMaps } from './whiteoutSections'
...
export const gamesData = {
  ...
  whiteoutSurvival: {
    ...
    maps: whiteoutMaps,
    facilities: whiteoutFacilities,
    fortresses: whiteoutFortresses,
    strongholds: whiteoutStrongholds,
    resources: whiteoutResources,
    events: whiteoutEvents,
    buildings: whiteoutBuildings,
    research: whiteoutResearch,
    troops: whiteoutTroops,
    beartrap: whiteoutBearTrap,
