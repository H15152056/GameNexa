...
const WHITEOUT_MAPS = [
  {
    ...
    subtitle: 'Imperial Foundry, Boiler Room, Central Transit, Mercenary Camp and Munitions Warehouse',
  ...
  },
  {
    ...
    subtitle: 'Alliance battlefield, objectives, lanes and strategic positions',
...
const MODULES = {
  facilities: {
    icon: '🏭',
    title: 'Facilities',
    intro: 'Important event and state facilities with their purpose, locations and strategic value.',
    sections: [
  ...
  fortresses: {
    icon: '🏰',
    title: 'Fortresses',
    intro: 'Organize fortress ownership, rallies, garrisons, rewards and alliance priorities.',
    sections: [
  ...
  strongholds: {
    icon: '🛡️',
    title: 'Strongholds',
    intro: 'Keep stronghold priorities, control status and defensive assignments organized.',
    sections: [
  ...
  resources: {
    icon: '🌲',
    title: 'Resources',
    intro: 'Whiteout Survival resource reference for gathering, protection and progression.',
    sections: [
      ...
      ['⛓️ Iron', 'Higher-value resource required for advanced upgrades.'],
  ...
  territory: {
    ...
    intro: 'Plan HQ placement, banners, connected territory and alliance expansion.',
    sections: [
  ...
  events: {
    icon: '⚔️',
    title: 'Events',
    intro: 'Central Whiteout Survival event reference and preparation hub.',
    sections: [
      ...
      ['⚔️ Foundry Battle', 'Plan objectives, movement, rallies and facility control.'],
      ['🏔️ Canyon Clash', 'Coordinate lanes, objectives and alliance battlefield assignments.'],
  ...
  buildings: {
    icon: '🏗️',
    title: 'Buildings',
    intro: 'Core settlement buildings and practical upgrade priorities.',
    sections: [
  ...
  research: {
    icon: '🔬',
    title: 'Research',
    intro: 'Research priorities organized around economy, battle and march development.',
    sections: [
  ...
  troops: {
    icon: '🎖️',
    title: 'Troops',
    intro: 'Understand Infantry, Lancer and Marksman roles and formation basics.',
    sections: [
  ...
  planner: {
    ...
    intro: 'A simple planning workspace for alliance officers and event coordination.',
    sections: [
  ...
  return (
    <section className="wnx-tools">
      <style>{`
        .wnx-tools{
          margin:28px 0 0;
          border:1px solid rgba(93,180,202,.2);
          border-radius:22px;
          background:linear-gradient(145deg,rgba(8,31,40,.98),rgba(4,20,27,.98));
          overflow:hidden;
        }

        .wnx-head{
          padding:28px;
          border-bottom:1px solid rgba(93,180,202,.14);
        }
        ...
        .wnx-overview-card{
          border:1px solid rgba(93,180,202,.16);
          background:#08232d;
          border-radius:15px;
          padding:19px;
          cursor:pointer;
        ...
        .wnx-overview-card:hover{
          border-color:#2c8296;
          transform:translateY(-2px);
        }

        .wnx-overview-card .icon{
          font-size:28px;
          margin-bottom:10px;
        }

        .wnx-overview-card h3{
          margin:0 0 7px;
          color:#effcff;
          font-size:16px;
        }
        ...
        .wnx-detail{
          border:1px solid rgba(93,180,202,.17);
          background:#08232d;
          border-radius:16px;
          padding:22px;
        }
        ...
        .wnx-back{
          border:1px solid rgba(93,180,202,.22);
          background:#09232d;
          color:#a8d3dd;
          border-radius:10px;
          padding:8px 13px;
        ...
        .wnx-map-button.active{
          border-color:#29afd0;
          background:#103d4a;
          color:#effcff;
        }

        .wnx-map-button strong,
        .wnx-map-button span{
          display:block;
        }
      ...
      <div className="wnx-head">
        ...
        <p>
          Explore facilities, fortresses, strongholds,
          resources, alliance territory, events,
          buildings, research, troops, calculators,
          battle maps and alliance planning tools.
        </p>
      </div>
          ...
          <>
            <div className="wnx-overview">
              ...
              >
                ...
                <p>
                  View available Foundry Battle and
                  Canyon Clash map images for planning.
                </p>
              </button>
            </div>
          </>
            ...
            <div className="wnx-map-card">
              <div className="wnx-map-buttons">
                {WHITEOUT_MAPS.map((item) => (
                  <button
                    key={item.id}
                    className={`wnx-map-button ${
                      activeMap === item.id
                        ? 'active'
                        : ''
                    }`}
                    onClick={() =>
                      setActiveMap(item.id)
                    }
                  >
                    <strong>
              ...
              <div className="wnx-detail-header">
                ...
                <div>
                  ...
                  <p className="wnx-detail-intro">
                    Use the map image as a visual
                    reference for alliance planning,
                    objectives, rallies and defense.
                  </p>
                </div>
              </div>

              <div className="wnx-list">
                <div className="wnx-list-card">
                  <strong>⚔️ Alliance Planning</strong>
                  <span>
                    Organize battlefield movement and
                ...
                <div className="wnx-list-card">
                  ...
                  <span>
                    Use the map to identify important
                    locations.
                  </span>
                </div>

                <div className="wnx-list-card">
                  <strong>🛡️ Defense</strong>
                  <span>
                    Prepare defensive positions and
                    assignments.
                  </span>
                </div>
                ...
                <div className="wnx-list-card">
                  ...
                  <span>
                    Coordinate rally locations and
                    movement.
                  </span>
                </div>
              </div>
          ...
          <div className="wnx-calc">
            <div className="wnx-calc-card">
              ...
              <div className="wnx-result">
                {resourceTotal.toLocaleString()} total
                RSS
              </div>
            </div>
