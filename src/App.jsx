  ...
  return (
    <div className="app">
      ...
      <footer>
        ...
        <div className="footer-links"><a href="#home">Home</a><a href="#games">Games</a><Link to="/guides">Guides</Link><Link to="/about">About</Link><Link to="/contact">Contact</Link><Link to="/privacy-policy">Privacy</Link><Link to="/terms-of-use">Terms</Link><Link to="/disclaimer">Disclaimer</Link><Link to="/dmca">DMCA</Link></div>
        <div className="footer-copy">© 2026 GameNexa. All rights reserved. GameNexa is an independent gaming information site and is not affiliated with the respective game publishers/developers unless stated.</div>
      </footer>
    </div>
  )
}
