...
function AdminPage() {
   ...
   * ============================================================
   *
   * This combines gamesData.js with all CMS-created guides.
   */
  ...
  /*
   * A CMS-created guide starts after all original guides.
   */
  ...
  const isEditingCMSGuide =
    !isCreatingGuide &&
    selectedGuide >= originalGuideCount &&
  ...
  function updateExistingSectionHeading(
    ...
    if (isEditingCMSGuide) {
      ...
      /*
       * Update the merged editor locally.
       * The actual save happens when
